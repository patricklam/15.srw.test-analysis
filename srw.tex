...
\begin{frame}
  \frametitle{Relative Sizes of Test Suites}
\begin{center}
...
\end{frame}
\note{
The limitations of our technique include not considering assertion
arguments and helper methods. Being oblivious to assertion arguments
increases our false positive rates but also helps us detect more
clones (a Precision vs Recall tradeoff situation). Our technique
is also unaware of helper methods that play major roles in some
test methods, but we argue that those methods are most likely already
refactored and less likely worth the effort to refactor.
}
