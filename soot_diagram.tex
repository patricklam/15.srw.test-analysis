\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=1.45cm,semithick,initial text=]
  ...
  \node[block]   (afa) [right of=ca,xshift=15em]  {\small [fingerprint(A)]};
  \node[block]   (afb) [right of=cb,xshift=15em]  {\small [fingerprint(B)]};
  \node[block]   (afc) [right of=cc,xshift=15em]  {\small [fingerprint(C)]};
